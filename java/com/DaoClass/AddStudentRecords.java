...
public class AddStudentRecords{
	...
	public void addRecords(String name,String gender,String department,String blood_group,String phoneno,String address,String email,String password) {
		...
		try {
			...
			ps=null;
			String qry="insert into " + table +"(sname,Gender,Dname,Dno,Phoneno,Email,pass,Address,Blood_Group) values(?,?,?,?,?,?,?,?,?)";
