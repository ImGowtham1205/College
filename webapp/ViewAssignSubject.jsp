...
<body>
	...
	if (session.getAttribute("Hodid") == null) {
		...
		List<FetchAssignStaff>list=fas.getStaff(hodid);
%>
...
<nav class="navbar">
 ...
 <!-- It Checks That You Assigned Any Subjects To Staffs If Assigend Then Display Staffs Who Are Handle Subject 
 Else It Display "You Didn't Assign Subjects To Any Staff" Message-->
  ...
  <% } else { %>
      <h3>Assigned Subjects For Staffs:</h3>
      
        <% for (FetchAssignStaff sub : list) {
