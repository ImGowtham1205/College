...
<body>
	...
	if (session.getAttribute("sid") == null) {
	  ...
	  //Getting Students Details For Mark Attendance To The Selected Subject By Calling fetchStudent() Method using Staff ID As Arugment
	    FetchStudentRecord fsr=new FetchStudentRecord();
	    List<SetStudent>list=fsr.fetchStudent(sid);
	%>
...
<!-- Time Selection Form For Mark Attendance To Selected Subject -->
...
%>
	<div class="error-msg">
   		Invalid Time Duration For Mark Attendance...
  </div>
<%} 
	else if("taken".equals(time)){
%>
	<div class="error-msg">
   		For This Hour Attendance Already Marked...
  </div>
<%} %>
<%
...
<%} %>
  ...
  <!-- If Both The Condition Is True Then Only Display The Attendance Form -->
...
%>
    ...
    <!-- Hidden Form To Access The Values In SubmitAttendance Servlet -->
    <input type="hidden" name="subject" value="<%= subject%>">
  	<input type="hidden" name="code" value="<%= code%>">
     ...
     <input type="hidden" name="endTime" value="<%= endTime %>">
      ...
      //To Stores Student Rollno In rollNumbers Hidden form To Access The Values In SubmitAttendance Servlet
        ...
        %>
        <input type="hidden" name="rollNumbers" value="<%= rollBuilder.toString() %>">
