...
<body>
	...
	if(session.getAttribute("Rollno")==null){
		...
		int rollno=Integer.parseInt(id);
		 ...
		 /*Getting Student Name ,Departmant Name & Number,Gender,Blood Group,Phone Number,Mail & Address
		 By Calling fetchName(),fetchDno(),fetchDname(),fetchGender(),fetchBlood(),fetchPhone(),fetchMail(),fetchAddress() Method
