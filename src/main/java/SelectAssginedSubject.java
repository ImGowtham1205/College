...
@WebServlet("/SelectAssginedSubject")
public class SelectAssginedSubject extends HttpServlet {
	//This Servlet Is Use For To Fetch The Assigned Subjects For Selected Semester
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((year==1 && sem==1)) {
			...
			request.getRequestDispatcher("ViewAssignSubject.jsp").forward(request, response);
		}
			...
			response.sendRedirect("ViewAssignSubject.jsp?fetch=error");
	}
}