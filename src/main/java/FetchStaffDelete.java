...
@WebServlet("/FetchStaffDelete")
public class FetchStaffDelete extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(name == null || name.isEmpty()) {
	         ...
	         response.sendRedirect("StaffDelete.jsp?fetchError=true");
		}
		...
		//If Record Found For The Given Staff Id Then It Set Session Values By Using setAttribute() Method
			...
			response.sendRedirect("StaffDelete.jsp");
		}
	}
}