...
@WebFilter("/DeleteCourse")
public class VerifyCourseDelete extends HttpFilter implements Filter {
	
	//Filter For To Check Admin ID Is Match To Thier Department Number If True Then It Allow To Delete Course Details
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		||(aid==3501 && dno==35)||(aid==4001 && dno==40)||(aid==4501 && dno==45))
		    ...
		    res.sendRedirect("DeleteCourse.jsp?error=unauthorized");
	}
}