...
<% } %>
  ...
  <!-- Form to fetch data -->
  <form id="fetchStaffForm" class="update-form" method="post" action="FetchStaffDelete" novalidate>
  ...
  <!-- Form to update data -->
  <form id="updateStaffForm" class="update-form" action="StaffDelete" method="post" novalidate>
   ...
   <label for="desigination">Desigination:</label>
	...
	<small class="error-text"></small>
     ...
     <button type="submit" id="updateBtn" <%= staffIdParam == 0 ? "disabled" : "" %>>Delete</button>
  </form>
</div>
</div>
